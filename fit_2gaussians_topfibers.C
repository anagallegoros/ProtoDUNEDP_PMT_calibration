...
//Macro created by Ana Gallego (ana.gallego@ciemat.es)
...
void fit_2gaussians_topfibers(string label, string pmt_info_file, const int nhvs){
   ...
   // int real_hv;
    ...
    if(label=="run_1382" || label=="run_1469_top" || label=="run_1471_top") string xled = "1 (top fiber #0)";
    if(label=="run_1383") string xled = "4 (top fiber #1)";
    if(label=="run_1384") string xled = "1 & 4";
    if(label=="run_1386") topfibers=0;
  //  if(label=="runs_1459_1471_top") string xled = "1 (top fiber #0)";
...
//        HV4[i] = hv4;
    ...
    for(int ihv=0;ihv<nhvs;ihv++){ // 4 HVs
        ...
        for(int i=0;i<npmts;i++){ // 36 histograms
            ...
            if(i==0){ //create a new canvas (64 boxes)
            ...
            //############################################
            if(label=="run_1382"){
                if(SN[i]=="FA0147" || SN[i]=="FA0113" || SN[i]=="FA0156" || SN[i]=="FA0133" || SN[i]=="FA0106" || SN[i]=="FA0116" || SN[i]=="FA0105" || SN[i]=="FA0112" || SN[i]=="FA0157" || SN[i]=="FA0151" || SN[i]=="FA0137" || SN[i]=="FA0134" || SN[i]=="FA0146" || SN[i]=="FA0121" || SN[i]=="FA0119" || SN[i]=="FA0115" || SN[i]=="FA0136"){
                    IGNORE[total] = 1;
                }
            }
            
            if(label=="run_1383"){
                if(SN[i]=="FA0147" || SN[i]=="FA0156" || SN[i]=="FA0133" || SN[i]=="FA0106" || SN[i]=="FA0157" || SN[i]=="FA0137" || SN[i]=="FA0134" || SN[i]=="FA0119"){
                    IGNORE[total] = 1;
                }
            }
          
                if(label=="run_1384"){
                    if(SN[i]=="FA0121" || SN[i]=="FA0146" || SN[i]=="FA0119" || SN[i]=="FA0115" || SN[i]=="FA0136" || SN[i]=="FA0147" || SN[i]=="FA0111" || SN[i]=="FA0106" || SN[i]=="FA0157" || SN[i]=="FA0134" || SN[i]=="FA0137" || SN[i]=="FA0133" || SN[i]=="FA0156"){
                        IGNORE[total] = 1;
                    }
                }
            ...
            if(IGNORE[total]==0) h[total]->Fit("g1","QER");
            ...
            while(error_spe>5 && p<50){ //important!
                ...
                //*******************
                    ...
                    if(label == "run_1383"){
                        ...
                        if(SN[i]=="FA0115" || SN[i]=="FA0136"  || SN[i]=="FA0114" || SN[i]=="FA0148"  || SN[i]=="FA0110" || SN[i]=="FA0124" || SN[i]=="FA0130"){
                            x1spe = 50e6;
                            x2spe = 150e6;
                        }
                ...
                if(IGNORE[total]==0) h[total]->Fit("g2","QER");
            ...
            //############################################
            // limits x axis --> PARTICULAR CASES:
            //############################################
            if(label=="runs_950_956"){
                if(hv==7){
                    if(SN[i]=="FA0151" || SN[i]=="FC0005" || SN[i]=="FA0153"){
                        x2 = 1500e6;
                    }
                    if(SN[i]=="FA0135"){
                        x2 = 400e6;
            ...
            if(label=="run_1382" || label=="run_1383" || label=="run_1384"){
                if(SN[i]=="FA0119" || SN[i]=="FA0106"){
                    x1 = -15e6;
                    x2 = 15e6;
                }
...
//
            if(nhvs==1){
                if(topfibers==1) string nameee = Form("%s, ADC ch #%i, LED #%s",SN[i].c_str(),ADC[i],xled.c_str());
                else string nameee = Form("%s, ADC ch #%i, LED #%i",SN[i].c_str(),ADC[i],LED[i]);
            }
    ...
    //change
    TFile *data1 = new TFile(Form("%s/FIT/HV_01_fits.root",label.c_str()),"READ"); // histograms
        ...
        for(int iout=0;iout<nhvs;iout++){ // hvs
           ...
           // TFile *data = new TFile(Form("%s/FIT/HV_0%i_fits.root",label.c_str(),this_hv),"READ"); // histograms
            ...
            if(nhvs==1){
             ...
             if(topfibers==1) name3 = Form("%s, ADC ch #%i, LED #%s",SN[l].c_str(),ADC[l],xled.c_str());
             else name3 = Form("%s, ADC ch #%i, LED #%i",SN[l].c_str(),ADC[l],LED[l]);
